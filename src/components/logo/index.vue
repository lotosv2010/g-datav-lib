...
export default {
  ...
  setup() {
    onMounted(() => {
      // console.log('path', document.getElementsByClassName('g-logo-path')[0].getTotalLength())
    });
    return{}
  }
}
...
@keyframes logo {
  0% {
    stroke-dasharray: 10132;
    stroke-dashoffset: 10132;
  }
  50% {
    stroke-dasharray: 10132;
    stroke-dashoffset: 0;
